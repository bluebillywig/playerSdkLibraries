...
install_xcframework "${PODS_ROOT}/../../bin/framework/BlueBillywigPlayerSDK.xcframework" "BlueBillywigPlayerSDK" "library" "ios-i386_x86_64-simulator" "ios-arm64_armv7_armv7s"
